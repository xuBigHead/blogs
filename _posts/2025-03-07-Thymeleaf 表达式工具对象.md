---
layout: post
title: 2025-03-07-第000章-Thymeleaf 表达式工具对象
categories: [Thymeleaf]
description: 
keywords: Thymeleaf 表达式工具对象.md
mermaid: false
sequence: false
flow: false
mathjax: false
 ...
 * **\#execInfo** : 表达式对象提供有关在 Thymeleaf 标准表达式内正在处理的模板的有用信息。
 ...
 * **\#uris** : 在Thymeleaf标准表达式中执行 URI/URL操作（尤其是转义/取消转义）的实用程序对象。
 ...
 * **\#conversions** : 实用程序对象允许在模板的任何位置执行*转换服务*:
 ...
 * **\#calendars** : 类似于`＃dates`，对应于`java.util.Calendar`对象：
 ...
 * **\#ids** : 实用方法用于处理重复的 `id`属性(比如，作为一个迭代器的结果)
