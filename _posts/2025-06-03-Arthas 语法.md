---
layout: post
title: 2025-06-03-第000章-Arthas 语法
categories: [Arthas]
description: 
keywords: Arthas 语法.md
mermaid: false
sequence: false
flow: false
mathjax: false
...
![1](https://oss.xubighead.top/oss/image/202506/1929825818919407618.png)
...
查看最繁忙的线程，以及是否有阻塞情况发生? 常规查看线程，一般我们可以通过 top 等系统命令进行查看，但是那毕竟要很多个步骤，很麻烦。

查看所有的线程信息和线程栈，包括总线程数、新线程数等信息和dashboard命令的第一部分。



![image-20220317195102741](https://oss.xubighead.top/oss/image/202506/1929825917837873153.png)
...
# 查看某个方法的信息，如果存在的话
sm com.tool.bookmark.entity.pojo.BookmarkClassify testMethod
```
...
$ jad com.tool.bookmark.controller.BookmarkController
```
...
```sh
$ monitor com.tool.bookmark.controller.BookmarkController list
```
...
```sh
$ watch com.tool.bookmark.controller.BookmarkController list
```
...
ts=2022-03-17 22:34:15; [cost=44.629703ms] result=@ArrayList[
    ...
    @R[R(code=200, success=true, data=com.baomidou.mybatisplus.extension.plugins.csvPagination.Page@64b9fbdb, msg=操作成功)],
]
...
```sh
$ stack com.tool.bookmark.controller.BookmarkController list
```
...
RETURN-OBJ     @R[                                                                                  
                   ...
                   data=@Page[com.baomidou.mybatisplus.extension.plugins.csvPagination.Page@2dadeec8], 
                   msg=@String[操作成功],                                                               
               ]                                                                                    
